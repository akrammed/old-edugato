...
.btn-border-white:hover {
    ...
    border: solid 1px #DB5461 !important;
}
...
<nav id="navbar" class="navbar navbar-expand-lg navbar-light">
    <div class="container">
        <div class="d-flex align-items-center justify-content-between w-100" style="height: 72px;">
            ...
            <div class="mx-lg-30 d-none d-lg-flex flex-grow-1 navbar-toggle-content " id="navbarContent">
                ...
                ?>
                    <li class="nav-item">
                        <?= $this->Html->link( __('Home'),'/home',['class' => 'nav-link']) ?>
                    </li>
                    <li class="nav-item">
                        <?= $this->Html->link( __('About'),'/about',['class' => 'nav-link']) ?>
                    </li>
                    <?php }?>
                    <li class="nav-item">
                        <?= $this->Html->link( __('Courses'),'/courses',['class' => 'nav-link']) ?>
                    </li>
                    <li class="nav-item">
                        <?= $this->Html->link( __('Contact us'),'/contact',['class' => 'nav-link']) ?>
                    </li>
                    <?php
                if ($currentSessionUser == null) {
            ?>
                    <li class="nav-item">
                        <?= $this->Html->link( __('Free Level Test'),'/test-lms',['class' => 'btn btn-border-white','style'=>'height: 39px;']) ?>
                    </li>
                    <li class="nav-item">
                        <button data-popup="login-pop-up" class="btn btn-border-white show-popup" style="height: 39px;">Login</button>
                    </li>
                    <?php
             }
            ?>
        ...
        ?>
                        ...
                        <div class="xs-w-100 d-flex align-items-center justify-content-between ">
                            ...
                            <div class="custom-dropdown navbar-auth-user-dropdown position-relative ml-50">
                                <div
                                    ...
                                    <?=  $this->Html->image('profile.png', ['class' => 'rounded-circle', 'escape' => false]) ?>
                                    <span class="font-16 user-name ml-10 text-dark-blue font-14">
                                        <?= $currentSessionUser['first_name'].' '.$currentSessionUser['last_name'] ?>
                                    </span>
                                </div>
                                                ...
                                                <div class="icons">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                        ...
                                                        <g id="Group_1264" transform="translate(-188.102 -869.102)">
                                                            <g id="Group_1262">
                                                                <g id="speedometer"
                                                                    transform="translate(188.102 869.102)">
                                                                    <path id="Path_1547"
                                                                    ...
                                                                    <path id="Path_1548"
                                                                        ...
                                                                        class="cls-1"
                                                                        transform="translate(-102.104 -305.954)" />
                                                                    <path id="Path_1549"
                                                                        ...
                                                                        class="cls-1"
                                                                        transform="translate(-202.104 -114.509)" />
                                                                    <path id="Path_1550"
                                                                        ...
                                                                        class="cls-1"
                                                                        transform="translate(-53.376 -53.375)" />
                                                                </g>
                                                            </g>
                                                        </g>
                                                    </svg>
                    ...
                    ?>
                                            ...
                                            <div
                                                ...
                                                <div class="icons">
                                                    <span class="sidenav-item-icon assign-strock mr-10">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                            viewBox="0 0 24 24" fill="none" stroke="#1f3b64"
                                        ...
                                        <li class="navbar-auth-user-dropdown-item">
                                            <div
                                                ...
                                                <div class="icons">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="23.999"
                                                        height="23.999" viewBox="0 0 23.999 23.999">
                ...
                <?php }else{?>
                    <button data-popup="register-pop-up" class="d-none d-lg-flex btn btn-sm btn-primary nav-start-a-live-btn btn-border-white show-popup" style="height: 39px;"><?= __('Create account')?></button>
                    <button data-popup="register-pop-up" class="d-flex d-lg-none text-primary nav-start-a-live-btn font-14" style="height: 39px;"><?= __('Create account')?></button>
