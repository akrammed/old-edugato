            ...
            <input type="hidden" name="_csrfToken" value="<?= $this->request->getAttribute('csrfToken') ?>">
                ...
                <section class="p-3 nameDesc" id="nameDesc">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control" name="picture" id="imgC" placeholder=""
                            aria-describedby="fileHelpId" />
                    </div>
                    <div class="mb-3">
                        <label for="" class="form-label">Upload a cover image (optional)</label>
                        <input type="file" class="form-control" name="background_picture" id="backImg" placeholder=""
                            aria-describedby="fileHelpId" />
                    </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#title').change(function () {
            $('.displayTitile').text($('#title').val());
        });
        $('#description').change(function () {
            $('.displayDescription').text($('#description').val());
        });
        $('#slug').change(function (){
            $('#slugText').val(`.../courses/${$('#slug').val()}`);
        })
