...
<html>
    <head>
        ...
        <meta name="_csrfToken" content="<?= $this->request->getAttribute(
            'csrfToken'
        ) ?>">
        <title>
            <?= $cakeDescription ?>
        ...
        <div class="layout-wrapper layout-content-navbar">
            <div class="layout-container">
                ...
                <div class="layout-page">
                    ...
                    <div class="content-wrapper px-3 px-px-lg-26">
                        <?= $this->Flash->render() ?>
                        <?= $this->fetch('content') ?>
                        ...
                        <?php echo $this->element('admin/add-canvas', [
                            'name' => 'Learning Path',
                    ...
                    <?php echo $this->element(
                        'Quiz-view/Scripts/globalFunctionQuizView'
                    ); ?>
                    <script async defer src="https://buttons.github.io/buttons.js"></script>
                    <?php echo $this->element(
                        'Quiz-create/Scripts/add-new-one'
                    ); ?>
                    <?php echo $this->element(
                        'Shorts/Scripts/short-create-script'
                    ); ?>
    </body>
</html>