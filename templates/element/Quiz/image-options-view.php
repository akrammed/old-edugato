...
foreach ($options as $key => $value) {
    ...
    echo  $this->Html->image('/img/uploads/picture/'.$value->qoption, ['alt' => 'Option ' . $key,'id'=>'Option-'.$key,'style'=>'height: 100%;', 'class'=>'Option-'.$key.' image-view clickable']);
    echo '</div>'; 
     $i++;
};
    ...
    $('#next').on('click', function(e) {
        ...
        if (correctAnswer === correctA) {
            ...
            $('#correct-answers').html(
                '<h3 style="margin-left: 6%;" class="wrong-title">That was not the correct picture !</h3>'
            );
        }
