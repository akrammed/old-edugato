<div class="container">
    <div class="row">
        ...
        <h3 style="margin-left: 4%;">Text Options</h3>
        <hr class="hr-style">
    </div>
    <div class="row">
...
" class="section-container-class">
            ...
            <?= $this->Form->create(null,['id' => 'myForm-test','class'=>'needId2']) ?>
  ...
  ?>
                ...
                <button id="add-option" style="margin-left: 0%;
    height: 35px;
